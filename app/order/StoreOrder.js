...
export default class NonlocalOder extends Component {
    constructor(props) {
        ...
        this.state = {
            tables: [
                {date: '2018-04-13',name:'张先生', price:'53322.34',place:'本店',state:'已完成',seek:'查看'},
            ],
            tableHead:["日期","会员名","金额","消费门店","状态","管理"],
            selected: "key1",
            type:1
    ...
    _item1(item) {
        return(
            <View style={{flex:1,height:40,flexDirection:'row'}}>
                ...
                <View style={{flex:1}}><Text style={{textAlign:'center',lineHeight:40,color:'#666'}}>{item.name}</Text></View>
                <View style={{flex:1}}><Text style={{textAlign:'center',lineHeight:40,color:'#666'}}>{item.price}</Text></View>
                <View style={{flex:1}}><Text style={{textAlign:'center',lineHeight:40,color:'#666'}}>{item.place}</Text></View>
                <View style={{flex:1}}><Text style={{textAlign:'center',lineHeight:40,color:'#666'}}>{item.state}</Text></View>
                <View style={{flex:1}}><Text style={{textAlign:'center',lineHeight:40,color:'#4baed0'}}>{item.seek}</Text></View>
